...
class Module(db.Model):
    ...
    module_uuid = db.Column(db.String(50), nullable=False)
    sharable_link = db.Column(db.String(300), nullable=False)
    user_id = db.Column(db.Integer, db.ForeignKey('user.id'), nullable = False)
    pdfs = db.relationship('Pdf', backref='module', lazy=True)
